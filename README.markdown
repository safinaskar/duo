...
Если вам всё ещё что-то непонятно, прочитайте этот IRC лог:
	...
	<vanile_joker111> как то забавно ты пишешь. одна программа без защиты памяти, без диспетчеризации, какая то библиотека, что это вообще такое ?
	<vanile_joker111> стэнд алоне какой то чтоли, дос программа, в реал моде или что ?
	<safinaskar> vanile_joker111: это я начал писать ос
	<safinaskar> vanile_joker111: пока начал писать ядро (kernel space)
	<safinaskar> vanile_joker111: в user space не вышел
	<safinaskar> vanile_joker111: поэтому нет нормальных процессов
	<safinaskar> vanile_joker111: и нет защиты памяти
	<vanile_joker111> кернел и юзер это термины оси?
	<safinaskar> vanile_joker111: да
	<safinaskar> vanile_joker111: а ещё это термины процессора
	<vanile_joker111> тоесть это реал моде процессора ?
	<safinaskar> vanile_joker111: да
	<vanile_joker111> язык как называется ?)
	<safinaskar> vanile_joker111: на котором duo? c++
	<vanile_joker111> ясно

 ...
 * Теоритически, здесь нужно поставить compile-time проверку на знаковость char'а, чтобы оптимизировать код на платформах с беззнаковым char'ом, но я не буду этого делать в такой простом ядре
 */
